            ...
            <table class="table table-striped">
                ...
                <tr>
                    <?php if (!empty($list_data)): ?>
                        ...
                        <th><?php echo $this->Paginator->sort('name', __('blog_name')); ?></th>
                        <th><?php echo $this->Paginator->sort('order', __('blog_weight')); ?></th>
                        <th><?php echo $this->Paginator->sort('modified', __('blog_modified')); ?></th>
                ...
                <?php if (!empty($list_data)): ?>
                    ...
                    <?php foreach ($list_data as $item): ?>
                        <tr class="form-edit">
                            ...
                            <td>
                                <?php
                                if (in_array('Blogs_edit_status_field', $permissions)) {
                                    echo $this->Form->input('status', array(
                                        'div' => false,
                                        'class' => 'form-control',
                                        'label' => false,
